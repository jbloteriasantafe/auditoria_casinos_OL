    ...
    function (t, e) {
      ...
      function d(t) {
        ...
        t.hoverPoint &&
          ...
          t.hoverPoint.plotY &&
          e.hoverPane &&
          !h(t.hoverPoint.plotX, t.hoverPoint.plotY, e.hoverPane.center) &&
          (t.hoverPoint = void 0);
      }
      function c(t) {
        let e = this.chart;
        ...
        class f extends a {
          ...
          getGraphPath(t) {
            ...
            for (h = (t = t || this.points).length; h--; ) {
              ...
              p.isNull || n || l || (t[h + 1] && !t[h + 1].isNull) || i.push(s),
                (d = {
            ...
            c &&
              (!0 === c && (c = "left"),
              (o.step = { left: "right", center: "center", right: "left" }[c]));
            let f = s.call(this, e),
              b = s.call(this, i);
            o.step = c;
            let m = [].concat(g, f);
            ...
            for (let M of t) {
              ...
              if (void 0 !== M.plotY) {
                ...
                (m = Math.round(L.width)),
                  ...
                  b ||
                    ((M.graphic = b = s.g("point").add(this.group)),
                    (M.stem = s
                      .path()
                    ...
                    (M.medianShape = s
                      ...
                      .add(b))),
                  i.styledMode ||
                    ((v.stroke = M.stemColor || e.stemColor || A),
                    (v["stroke-width"] = l(
                      M.stemWidth,
                      e.stemWidth,
                      e.lineWidth
                    ...
                    (v.dashstyle =
                      M.stemDashStyle || e.stemDashStyle || e.dashStyle),
                    M.stem.attr(v),
                    a &&
                      ((C.stroke = M.whiskerColor || e.whiskerColor || A),
                      (C["stroke-width"] = l(
                        M.whiskerWidth,
                        e.whiskerWidth,
                        e.lineWidth
                      ...
                      M.whiskers.attr(C)),
                    o &&
                      ((k.fill = M.fillColor || e.fillColor || A),
                      (k.stroke = e.lineColor || A),
                      (k["stroke-width"] = e.lineWidth || 0),
                      (k.dashstyle =
                        M.boxDashStyle || e.boxDashStyle || e.dashStyle),
                      M.box.attr(k)),
                    (w.stroke = M.medianColor || e.medianColor || A),
                    (w["stroke-width"] = l(
                      M.medianWidth,
                      e.medianWidth,
                      e.lineWidth
                    ...
                    (w.dashstyle =
                      M.medianDashStyle || e.medianDashStyle || e.dashStyle),
                    M.medianShape.attr(w)),
                  (N = [
                    [
                      "M",
                      (g = y + P + (u = (M.stem.strokeWidth() % 2) / 2)),
                      n,
                    ],
                    ["L", g, h],
                    ["M", g, r],
                  ...
                  M.stem[t]({ d: N }),
                  o &&
                    ((r = Math.floor(r) + (u = (M.box.strokeWidth() % 2) / 2)),
                    (n = Math.floor(n) + u),
                    (y += u),
                    (x += u),
                    (N = [
                    ...
                    M.box[t]({ d: N })),
                  a &&
                    ((h += u = (M.whiskers.strokeWidth() % 2) / 2),
                    (p += u),
                    (N = [
                      [
                        "M",
                  ...
                  (N = [
                    [
                      ...
                      (d =
                        ...
                        (u = (M.medianShape.strokeWidth() % 2) / 2)),
                    ],
                    ["L", x, d],
                  ]),
                  M.medianShape[t]({ d: N });
        ...
        class a extends s {
          haloPath(e) {
            return t.prototype.haloPath.call(
              this,
              0 === e ? 0 : ((this.marker && this.marker.radius) || 0) + e
            );
          }
        }
            ...
            !t &&
              ...
              this.points.forEach(function (t) {
                ...
                e &&
                  e.width &&
                  (this.hasRendered ||
                    e.attr({ x: t.plotX, y: t.plotY, width: 1, height: 1 }),
            ...
            this.points)) {
              ...
              e.centerInCategory &&
                ...
                (i.tooltipPos = t.inverted
                  ? [a.len + a.pos - t.plotLeft - f, this.xAxis.len - x - b, y]
        ...
        return class extends s {
          ...
          firePointEvent() {
            ...
            if (this.isParentNode && i.parentNode) {
              ...
              (i.allowPointSelect = i.parentNode.allowPointSelect),
          ...
          select() {
            ...
            this.isParentNode
              ? ((s.getSelectedPoints = s.getSelectedParentNodes),
                ...
                (s.getSelectedPoints = t.prototype.getSelectedPoints))
              : e.prototype.select.apply(this, arguments);
          }
        };
      }
            ...
            let e = this.box,
              ...
              l = (t) => {
                for (let e of t.linksFrom || [])
                  r[e.toNode.id] ||
                    ((r[e.toNode.id] = !0), h.push(e.toNode), l(e.toNode));
              },
              h = [];
            for (let t of a) h.push(t), l(t);
            if (h.length) for (let t of i) -1 === h.indexOf(t) && h.push(t);
            else h = i;
            for (let i = 0, s = h.length; i < s; ++i)
              ((t = h[i]).plotX = t.prevX =
                d(t.plotX, e.width / 2 + n * Math.cos(i * o))),
                (t.plotY = t.prevY =
                  d(t.plotY, e.height / 2 + n * Math.sin(i * o))),
                (t.dispX = 0),
                (t.dispY = 0);
          }
          setRandomPositions() {
          ...
          setCircularPositions() {
            ...
            for (let i of e)
              this.options.splitSeries && !i.isParentNode
                ...
                (i.plotX = i.prevX =
                  n(i.plotX, a + o * Math.cos(i.index || l * s))),
                (i.plotY = i.prevY =
                  n(i.plotY, r + o * Math.sin(i.index || l * s))),
                (i.dispX = 0),
                (i.dispY = 0),
                l++;
          }
              ...
              (a.degree = a.mass),
                ...
                s.nodes.forEach((r) => {
                  (t = 0),
                    a !== r &&
                      !a.fixedPosition &&
                      (s.options.seriesInteraction || a.series === r.series) &&
                      ((i = s.getDistXY(a, r)),
                      (e =
                        s.vectorLength(i) -
                        (a.marker.radius + r.marker.radius + o)) < 0 &&
                        ((a.degree += 0.01),
                        a.neighbours++,
                        (t = s.repulsiveForce(
                          -e / Math.sqrt(a.neighbours),
                          s.k,
                          a,
                          r
                        ))),
                      s.force("repulsive", a, t * r.mass, i, r, e));
                });
            });
          }
          applyLimitBox(t, e) {
      ...
      function (t, e, i, s, o, a, r, n, l, h) {
        ...
        class v extends u {
          ...
          createParentNodes() {
            ...
            s.parentNodeOptions && (r = L(s.parentNodeOptions.marker || {}, r)),
              (this.parentNodeMass = 0),
              this.points.forEach((t) => {
          ...
          drawGraph() {
            ...
            let t = this.chart,
              ...
              i = {
                fill: e.fillColor || p(this.color).brighten(0.4).get(),
              ...
              o &&
                ...
                o.nodes.forEach((e) => {
                  t &&
                    ...
                    ((i = s.getDistXY(t, e)),
                    s.vectorLength(i) - e.marker.radius - t.marker.radius < 0 &&
                      (e.series.addPoint(
                        L(t.options, { plotX: t.plotX, plotY: t.plotY }),
                        !1
                      ),
          ...
          (function (t) {
            ...
            function v(t) {
              ...
              if (
                ...
                (f = Math.sqrt(Math.pow(v - l, 2) + Math.pow(C - h, 2))),
                  (m = "string" == typeof r ? b(r, 1) : r / f),
                  (y = "string" == typeof n ? b(n, 1) : n / f),
                  e && c && (m < (g = c / f) && (m = g), y < g && (y = g)),
                  (L = [
                    ["M", l + m * (v - l), h - m * (h - C)],
                    ["L", v - (1 - y) * (v - l), C + (1 - y) * (h - C)],
                  ]);
              else if (
            ...
            function C(t, e) {
              ...
              return this.postTranslate(
                ...
                g(this.isCircular ? e : i < 0 ? 0 : i, this.center[2] / 2) -
                  this.offset
              );
            }
            function w() {
            ...
            function N() {
              ...
              if (!i && s && (t.angular || t.polar)) {
                let t = 2 * Math.PI,
                  ...
                  s =
                    ((g(o.endAngle, g(o.startAngle, 0) + 360) - 90) * Math.PI) /
                    180;
            ...
            function I(t) {
              ...
              i.isRadial &&
                ((p = i.getPosition(
                  this.pos,
                  i.center[2] / 2 +
                    b(g(o.distance, -25), i.center[2] / 2, -i.center[2] / 2)
                )),
                "auto" === o.rotation
                  ? e.attr({ rotation: a })
                  : h(l) ||
                ...
                "auto" === c &&
                  ...
                  m < 15
                    ? (x = "start" === u ? -(0.15 * s.height) : 0.15 * s.height)
                    : m > 165 &&
                      m <= 180 &&
                      (x =
            ...
            function O(t) {
              let { coll: a } = this,
                { angular: r, inverted: n, polar: l } = this.chart,
                h = {};
              r
                ...
                : l &&
                  (h = this.horiz
                    ? u(o.xAxis, e)
                    : u("xAxis" === a ? o.xAxis : o.yAxis, s)),
                n &&
                  "yAxis" === a &&
                  ((h.stackLabels = c(o.yAxis, !0) ? o.yAxis.stackLabels : {}),
                  (h.reversedStacks = !0));
        ...
        function T() {
          ...
          if (s.isRadial)
            for (
                  ...
                  e && o.stacking
                    ? ((w =
                      ...
                      this.visible &&
                        ...
                        ((C =
                          w[k].points[
                            this.getStackIndicator(void 0, k, this.index).key
                          ]),
                        (S = o.translate(C[0])),
                        (M = o.translate(C[1])),
                        h(S) && (S = a.clamp(S, 0, c))))
                ...
                (m.shapeArgs = {
                  ...
                  (m.plotY =
                    (h(this.translatedThreshold) &&
                      (S < this.translatedThreshold ? S : M)) - l);
              } else
                (S = A + l),
              ...
              this.polar.toXY(m),
                i.inverted
                  ? ((L = o.postTranslate(m.rectPlotY, A + m.pointWidth / 2)),
                    (m.tooltipPos = [L.x - i.plotLeft, L.y - i.plotTop]))
                    ...
                    s.points.forEach((t) => {
                      (f = t.graphic),
                        ...
                        f &&
                          b &&
                          (f.attr({ r: g, innerR: g }),
                          f.animate({ r: m, innerR: y }, s.options.animation));
                    }))
                  : i
                  ? ((c = {
                      translateX: l[0] + h,
      ...
      function (t, e, i, s, o) {
        ...
        class m extends a {
          ...
          getCrispPath() {
            ...
            for (let h = 1; h < i; h++) {
              if (
                !(this.options.connectNulls || c(this.data[t[h].index - 1].y))
              )
                continue;
              let i = t[h].box,
                p = t[h - 1],
              ...
              if (g && u && i) {
                ...
                if (n) {
                  ...
                  t =
                    Math.round(e.translate(i, !1, !0, !1, !0) + (r ? f : 0)) -
                    s;
                } else t = u.y + p.minPointLengthOffset + o - s;
                l.push(
                  ["M", (u.x || 0) + (a ? 0 : u.width || 0), t],
        ...
        return (
          ...
          (m.compose = i.compose),
          d(m.prototype, { pointValKey: "y", showLine: !0, pointClass: s }),
          n(
            m,
            "afterColumnTranslate",
            function () {
              ...
              for (let t = 0; t < e.length; t++) {
                let f = e[t],
                  ...
                  P = f.shapeArgs,
                  S = d({ x: 0, y: 0, width: 0, height: 0 }, P || {});
                f.box = S;
                let M = [0, x],
                  L = f.y || 0;
                if (r) {
                  if (n) {
                    let e = n[t];
                    "overlap" === r
                      ? ((g = e.stackState[e.stateIndex--]),
                        (p = L >= 0 ? g : g - L),
                        b(e, "absolutePos") && delete e.absolutePos,
                        b(e, "absoluteNeg") && delete e.absoluteNeg)
                      : (L >= 0
                          ? ((g = e.threshold + e.posTotal),
                            (e.posTotal -= L),
                            (p = g))
                          : ((g = e.threshold + e.negTotal),
                            (e.negTotal -= L),
                            (p = g - L)),
                        !e.posTotal &&
                          c(e.absolutePos) &&
                  ...
                  (p = Math.max(h, h + L) + M[0]),
                    ...
                    f.isSum
                      ...
                      ? (L >= 0
                          ? ((m = M[1] + l), (y = l))
                          : ((m = l), (y = M[1] + l)),
                        i.reversed && ((m ^= y), (y ^= m), (m ^= y)),
                        (S.y = i.translate(m, !1, !0, !1, !0)),
                        (S.height = Math.abs(
                          S.y - Math.min(i.translate(y, !1, !0, !1, !0), i.len)
                        )),
                        (l += M[1]),
                        (f.below = m <= a))
                      : ((S.height =
                          x > 0
                            ...
                            : i.translate(h, !1, !0, !1, !0) -
                              i.translate(h - x, !1, !0, !1, !0)),
                        (h += x),
                        (f.below = h < a)),
                    S.height < 0 && ((S.y += S.height), (S.height *= -1));
                (f.plotY = S.y =
                  Math.round(S.y || 0) - (this.borderWidth % 2) / 2),
                  (S.height = Math.max(Math.round(S.height || 0), 0.001)),
                  ...
                  S.height <= s && !f.isNull
                    ? ((S.height = s),
                      ...
                      L < 0
                        ...
                        : (f.minPointLengthOffset = o))
                    : (f.isNull && (S.width = 0), (f.minPointLengthOffset = 0));
